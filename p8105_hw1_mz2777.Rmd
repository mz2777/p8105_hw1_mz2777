...
pic1 = ggplot(df_p2, aes(x = x, y = y, color = logic_vec)) + geom_point() + ggtitle("Color points using the logical variable")
#color point using the numeric variable
pic2 = ggplot(df_p2, aes(x = x, y = y, color = logic2num)) + geom_point() + ggtitle("Color points using the numeric variable")
#color point using the factor variable
pic3 = ggplot(df_p2, aes(x = x, y = y, color = logic2fac)) + geom_point() + ggtitle("Color points using the factor variable")
